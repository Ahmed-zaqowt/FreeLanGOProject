        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form_add" action="{{ route('admin.text.store') }}" id="form_add" enctype="multipart/form-data"
                        action="" method="POST">
                        @csrf
                        <div class="mb-2 form-group">
                            <label class="form-label">@lang('الرسالة')</label>
                            <input placeholder="@lang(' الرسالة')" name="text" class="form-control" type="text">
